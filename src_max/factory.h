...
public:
    ...
    class WARP_GENERATING {
        ...
        static constexpr double _speedRate = 2;
    public:

        static double GetPeriod() {
            return Distribution::Normal(_alfa, _beta, _offset, MINUTE) * _speedRate;
        }
    };
    ...
    public:
        static bool GoGluing() {
            return Distribution::Gamma(_alfaGo, _betaGo, 0, PERCENT);
        }
